...
describe ('Central de Atendimento ao cliente TAT', function(){
    ...
    it.only('Seleciona um arquivo utilizando uma fixture para qual foi dado um alias',function(){
    ...
    it.only('Acessa a página de política de privacidade removendo o target e então  ', function(){
        cy.get('#privacy a')
        .invoke('removeAttr', 'target' )
        .click()

        cy.contains('Talkg About Testing').should('be.visible')
